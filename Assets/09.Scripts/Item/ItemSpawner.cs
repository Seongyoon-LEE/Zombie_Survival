...
public class ItemSpawner : MonoBehaviourPun
{
    ...
    void Start()
    {
        //playerTr = GameObject.FindGameObjectWithTag("Player").transform; // 플레이어 트랜스폼 찾기
